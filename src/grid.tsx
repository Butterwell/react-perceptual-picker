import { toOklab, fromOklab } from "./oklab";
...
const lin = (a: number, d: number) => (t) => a + t * d;
...
export const chunks = (start: number, end: number, count) => {
...
export const vec = (n: number, start: number, end: number, spread: number) => {
...
export const grid = (centerColor, spread: number) => {
